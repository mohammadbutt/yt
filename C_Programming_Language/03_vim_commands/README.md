...
* ### 12: <kbd>Esc</kbd> + <kbd>/</kbd> + "word to search" - Search / Find:
...
* ### 18: <kbd>Esc</kbd> + `:%s/source/destination` - Search and replace
